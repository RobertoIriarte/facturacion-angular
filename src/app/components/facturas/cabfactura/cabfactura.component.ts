...
export class CabfacturaComponent implements DoCheck {
  ...
  onSubmit() {
    ...
    this.formulario.patchValue({
      rut: this.clienteSeleccionado.rut,
    ...
    const datosEnviar = {
      ...
      "rutCliente": this.clienteSeleccionado.rut,
  ...
  seleccionarCliente(idCliente: any): void{
    ...
    this.clienteSeleccionado = this.clientes.find(cliente => cliente.rut == idCliente.value);
  }
  ...
  validarFormularios(){
    if (this.clienteSeleccionado) {
      ...
      //this.formulario.get('rut')?.setValidators(Validators.required);
    ...
    this.formulario.get('rut')?.updateValueAndValidity();
